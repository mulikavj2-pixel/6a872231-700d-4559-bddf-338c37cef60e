...
export const metadata: Metadata = {
  title: "Coffee House | Premium Specialty Coffee & Artisan Cafe",
  description: "Experience ethically sourced specialty coffee roasted fresh daily. Visit our cozy cafe for espresso, cappuccino, and unique single-origin blends.",
  keywords: "specialty coffee, artisan cafe, espresso, cappuccino, coffee shop",
  openGraph: {
    title: "Coffee House | Premium Specialty Coffee & Artisan Cafe",
    description: "Experience ethically sourced specialty coffee roasted fresh daily",
    siteName: "Coffee House",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1766057061411-2kjy9ldw.jpg",
        alt: "Premium coffee shop atmosphere"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "Coffee House | Premium Specialty Coffee",
    description: "Discover artisan coffee culture at its finest",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1766057061411-2kjy9ldw.jpg"]
  }
};
